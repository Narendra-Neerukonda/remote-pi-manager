...
def sendtext(message):
    print(message)
    response = requests.get("https://api.telegram.org/bot"+auth_config['bot']['token']+"/sendMessage?chat_id="+auth_config['bot']['chat_id']+"&parse_mode=Markdown&text="+str(message))
